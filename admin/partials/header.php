            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="best_saler.php">Best Saler</a></li>
...
<style>
        ...
        .navbar-toggler-icon {
            ...
            /* Màu trắng cho biểu tượng toggle */
        }

        .nav-item {
            position: relative;
            /* Dùng để tạo gạch dưới */
        }
